...
pub type CmdResultSender = std::sync::mpsc::Sender<types::SafeResult<types::CommandResult>>;
/// Channel receiver for a single executed command result.
pub type CmdResultReceiver = std::sync::mpsc::Sender<types::SafeResult<types::CommandResult>>;
